        ...
        text = {
            Column(
                ...
                ExposedDropdownMenuBox(
                    ...
                    OutlinedTextField(
                        value = Role.entries.find { it.name == employee.role }?.name ?: "בחר תפקיד",
                        onValueChange = {},
                        readOnly = true,
                        label = { Text("תפקיד") },
                        trailingIcon = {
                    ...
                    ExposedDropdownMenu(
                        ...
                        Role.entries.forEach { roleValue ->
                            DropdownMenuItem(
                                text = {
                                    Text(
                                        text = roleValue.name,
                                ...
                                onClick = {
                                    onEmployeeChange(employee.copy(role = roleValue.name))
                                    if (formErrors.roleError != null) {
        ...
        confirmButton = {
            Button(
                onClick = {
                    ...
                    formErrors = employeeViewModel.validateEmployeeInput(employee)
...
// פונקציות עזר (בדיוק כמו ב-AddNewEmployeeDialog)
