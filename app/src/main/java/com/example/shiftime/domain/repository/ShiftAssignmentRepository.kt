...
interface ShiftAssignmentRepository {
    ...
    fun getShiftWithAssignedEmployees(shiftId: Long): Flow<ShiftWithAssignedEmployees>
    fun getEmployeeWithAssignedShifts(employeeId: Long): Flow<EmployeeWithAssignedShifts>
